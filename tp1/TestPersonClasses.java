...
public class TestPersonClasses {
    public static void main(String[] args) {
        Person person = new Person("Alisson", "Rua 5");
        System.out.println(person);

        Student student = new Student("Leonardo", "Rua 9", "Computer Science", 2, 2000.0);
        System.out.println(student);

        Staff staff = new Staff("Dio", "Av. Central", "Saulo", 3000.0);
